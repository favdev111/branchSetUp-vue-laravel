<template>
    <div class="report-col">
        ...
        <div class="address-row" v-for="(address, key) in addresses" :index="key">
            <div class="form-row">
                <div class="form-group col-6" :class="{'has-error': $v.addresses.$each[key].address_type.$error}">
                ...
                <div class="form-group col-6" :class="{'has-error': $v.addresses.$each[key].zipcode.$error}">
                ...
                <div class="form-group col-6" :class="{'has-error': $v.addresses.$each[key].county.$error}">
                ...
                <div class="form-group col-6" :class="{'has-error': $v.addresses.$each[key].city.$error}">
